...
/// an unrecognized OpenCL exception
    ...
    mixin template CLExceptTempl(string name)
    {
	mixin("class " ~ name ~ " : CLException\n" ~
	      q{
		  {
    ...
    mixin CLExceptTempl!("CLPlatformException");

    // device exceptions base class
    mixin CLExceptTempl!("CLDeviceException");

    // context exceptions base class
    mixin CLExceptTempl!("CLContextException");

    // event exceptions base class
    mixin CLExceptTempl!("CLEventException");

    // program exceptions base class
    mixin CLExceptTempl!("CLProgramException");

    // buffer exceptions base class
    mixin CLExceptTempl!("CLBufferException");

    // kernel exceptions base class
    mixin CLExceptTempl!("CLKernelException");

    // command queue exceptions base class
    mixin CLExceptTempl!("CLCommandQueueException");
