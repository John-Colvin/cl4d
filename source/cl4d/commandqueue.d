...
public:
    ...
    {
        cl_errcode res;
	auto flags = (outOfOrder ? CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE : cast(cl_command_queue_properties) 0)
	           | (profiling  ? CL_QUEUE_PROFILING_ENABLE              : cast(cl_command_queue_properties) 0);

        this(clCreateCommandQueue(context.cptr, device.cptr, flags, &res));
