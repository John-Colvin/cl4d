...
/**
 *  this template is used to mixin low level CL C object handling into all CL classes
 ...
 */ 
public template CLWrapper(string T, string classInfoFunction)
{
    enum CLWrapper = 
    "private enum string Tname = \"" ~ T ~ "\";\n" ~
    "private alias classInfoFunction = " ~ classInfoFunction ~ ";\n" ~
    "private alias " ~ T ~ " T;\n" ~ 
    q{
